...
function About() {
  ...
  let tstack = ["HTML", "CSS", "JavaScript", "React", "Node", "Express", "TypeScript", "Tailwind CSS", "NEXT JS", "Axios", "Framer Motion", "GIT", "ZOD", "MONGODB", "POSTGRES", "Prisma"];
  ...
  return (
    ...
    id='about'
      ref={ref} 
      className='bg-custom-radial-gradient2 h-screen w-screen max-w-full overflow-x-hidden relative'
      initial="hidden"
      animate={inView ? "visible" : "hidden"}
      variants={containerVariants}
    >
      <h1 className='text-center text-5xl font-bold mt-16'>About Me</h1>
      <div className='flex mt-6 justify-center'>
        <motion.div variants={imageVariants}>
          <img 
            src={profile} 
            alt="Profile picture of Shreyansh" 
            className='rounded-full h-[384px] w-[384px] shadow-2xl shadow-gray-600' 
            loading="lazy"
          />
        </motion.div>
        <motion.div className='ml-4' variants={itemVariants}>
          <div className='text-3xl text-blue-400 font-bold mb-7'>Hi, I'm Shreyansh</div>
          <p className='text-lg font-thin leading-loose'>
          ...
          <div className='mt-9'>
            <div className='text-3xl text-blue-400 mb-7'>Tech Stack</div>
            <motion.div className='grid grid-cols-6 gap-2' variants={containerVariants}>
